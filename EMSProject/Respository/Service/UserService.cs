...
namespace EMSProject.Respository.Service
{
    public class UserService:IUser
    {
        ...
        private  void SendMail(string to,string Otp)
        {
            ...
            mail.To.Add(to);
            mail.From = new MailAddress("asif001@gmail.com");
            ...
            smtp.Credentials = new System.Net.NetworkCredential("asif001@gmail.com", "9876543210"); // Enter seders User name and password  
            smtp.EnableSsl = true;
            smtp.Send(mail);
